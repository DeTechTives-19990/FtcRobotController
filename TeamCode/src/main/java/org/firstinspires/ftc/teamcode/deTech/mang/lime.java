...
public class lime {
    public static final double limeMoutAnge = 25.0;
    public static final double limeMoutHegh = 12.25; 
    public static final double limeApriHegh = 29.50;

    private final Limelight3A limeligt;
